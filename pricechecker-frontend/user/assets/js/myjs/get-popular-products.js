function getAmazonProducts(maxNumberOfProducts) {
  let resultHtml = "";
  let url =
    "https://amazon23.p.rapidapi.com/product-search?query=laptop&country=US";
  $.ajax({
    async: false,
    crossDomain: true,
    url: url,
...
function getEbayProducts(maxNumberOfProducts) {
  let resultHtml = "";
  let url =
    "https://ebay-data-scraper.p.rapidapi.com/products?page_number=1&product_name=iphone&country=us";
  $.ajax({
    async: false,
    crossDomain: true,
    url: url,
